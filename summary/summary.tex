...
% fig 2 performance in global PCA for four cells
% fig 3 performance with global PCA and without PCA
% fig 4 performance compared removing algorithm, initial algorithm.
